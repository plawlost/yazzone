    ...
    <div className="w-full max-w-4xl">
      <div className="mb-12 space-y-4">
        <input
          ...
          className="w-full px-4 py-3 text-base border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400"
        />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
          ...
          <select
            ...
            className="px-3 py-1.5 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 bg-white w-full sm:w-auto"
          >
      ...
      <div className="border-t border-gray-200">
        {filteredEssays.length > 0 ? (
          filteredEssays.map((post) => (
            <article key={post.slug} className="border-b border-gray-200">
              <Link href={`/essays/${post.slug}`} className="block py-6 sm:py-8">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                  <div className="flex-grow space-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 text-sm text-gray-500 space-y-1 sm:space-y-0">
