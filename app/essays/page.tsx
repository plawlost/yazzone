...
export default function EssaysPage() {
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto">
      <Link
        href="/"
        className="text-sm underline decoration-1 underline-offset-2 text-black/60 hover:text-black transition-colors"
      >
        ← Return to homepage
      </Link>
      <header className="space-y-4">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tighter">Essays</h1>
        <p className="text-lg sm:text-xl text-black/80 max-w-2xl">
