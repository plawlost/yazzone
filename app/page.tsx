...
At 14 we built Clade AI on my front porch — a hardware-native assistant that ran off-device. We shipped prototypes, learned the hard problems of voice, latency, and inference at the edge, then shut it down when the team collapsed. Around the same time I became one of the first civilian testers of GPT-2 and DALL·E 1, which pulled me deep into generative models and human-machine interfaces.
